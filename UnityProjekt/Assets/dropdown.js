    ...
    function OnGUI () {
       if(GUI.Button (Rect(10, Screen.height/5, Screen.width/5, Screen.height/15), "Information")) {
          showDropdown = !showDropdown;
          lastSelection = dropdownGridInt;
       }
       if(showDropdown){
          //code for Scrollview & SelectionGrid
          scrollViewVector=GUI.BeginScrollView (Rect (100, Screen.height/5, Screen.width/8, Screen.height/14), scrollViewVector, Rect (0, 0, Screen.width/12, 300),false,true);
